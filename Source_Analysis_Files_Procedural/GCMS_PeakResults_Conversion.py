...
import pandas as pd
import re
from Source_GCMS_Analysis.rootDir import (path_GCMS_Peak_ResultsSorted, path_GCMS_Peak_Results,
                                          path_GCMS_Peak_ResultsUnprocessed)

# Read through the peak results file
with open(path_GCMS_Peak_ResultsUnprocessed, 'r', encoding='UTF-8') as file:
...
with open(path_GCMS_Peak_Results, 'w', encoding='UTF-8') as file:
...
# Create a new CSV file with processed, comma-delimited lines
with open(path_GCMS_Peak_ResultsSorted, 'w', encoding='UTF-8') as file:
